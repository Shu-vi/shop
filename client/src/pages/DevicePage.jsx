...
const DevicePage = observer(() => {
    ...
    const [buttonStyles, setButtonStyles] = useState({
        backgroundColor: 'rgba(0, 0, 0, 0)', border: '1px solid black',
        ...
        <div style={{maxWidth: '1340px', margin: '25px auto 0 auto', display: 'flex', flexDirection: 'column'}}>
                ...
                <div style={{marginRight}}>
                    <div style={{display: 'flex', flexDirection: 'column', alignItems: 'center'}}>
                        ...
                        <div style={{
                            ...
                            background: `url(${bitStar}) no-repeat center center`,
                            width: 240,
                            height: 240,
                    ...
                    <div style={{
                        ...
                        <h3 style={{fontWeight: 400}}>От: {device.price} руб.</h3>
                        {
                            <button style={buttonStyles}
                                    ...
                                    onPointerEnter={() => setButtonStyles({
                                    ...
                                    onPointerLeave={() => setButtonStyles({
            ...
            <div>
                ...
                {device.info.map((info, index) => {
                    return <div key={info.id} style={{
                        backgroundColor: index % 2 === 0 ? '#BBB' : '#FFF',
                        fontSize: 20,
                        padding: '10px 5px'
                    }}>{info.title}: {info.description}</div>;
                })}
            </div>
        </div>
    );
